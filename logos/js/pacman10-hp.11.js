(function () {
    ...
    ea("Map", function (a) {
        ...
        c.prototype.set = function (a, b) {
            ...
            c.La ? c.La.value = b : (c.La = {
                        ...
                        key: a,
                        value: b
                    }, c.list.push(c.La), this.i.Ua.next = c.La, this.i.Ua = c.La, this.size++);
            return this
        };
        c.prototype["delete"] = function (a) {
            a = d(this, a);
            return a.La && a.list ? (a.list.splice(a.index, 1), a.list.length || delete this.j[a.id], a.La.Ua.next = a.La.next, a.La.next.Ua =
                    a.La.Ua, a.La.head = null, this.size--, !0) : !1
        };
            ...
            for (var eb, fb = 0, gb = wa(String(Xa)).split("."), hb = wa("9").split("."), ib = Math.max(gb.length, hb.length), jb = 0; 0 == fb && jb < ib; jb++) {
                ...
                do {
                    ...
                    if (0 == mb[0].length && 0 == nb[0].length)
                        break;
                    fb = xa(0 == mb[1].length ? 0 : parseInt(mb[1], 10), 0 == nb[1].length ? 0 : parseInt(nb[1], 10)) || xa(0 == mb[2].length, 0 == nb[2].length) || xa(mb[2],
                            nb[2]);
                    kb = mb[3];
                    lb = nb[3]
                } while (0 == fb)
    ...
    yb.prototype.add = function (a, b, c, d, e) {
        ...
        -1 < l ? (b = a[l], c || (b.Ab = !1)) : (b = new wb(b, this.src, f, !!d, e), b.Ab = c, a.push(b));
        return b
    };
    var zb = function (a, b) {
        var c = b.type;
        if (c in a.i) {
            ...
            f && (xb(b), 0 == a.i[c].length && (delete a.i[c], a.j--))
        }
    };
        ...
        if ("array" == ma(b))
            ...
            if (!c.i) {
                ...
                if (a.addEventListener)
                    pb || (d = f), void 0 === d && (d = !1), a.addEventListener(b.toString(), e, d);
        ...
        if (a = Hb(a))
            if (b = a.i[b.toString()])
                for (b = b.concat(), a = 0; a < b.length; a++) {
                    var f = b[a];
                    f && f.capture == c && !f.removed && (f = Jb(f, d), e = e && !1 !== f)
                }
        return e
    },
    Jb = function (a, b) {
        ...
        if (a.Ab && "number" != typeof a && a && !a.removed) {
            ...
            if (e && e[ub])
                ...
                Cb--;
                (f = Hb(e)) ? (zb(f, a), 0 == f.j && (f.src = null, e[Ab] = null)) : xb(a)
            }
        }
        return c.call(d, b)
    },
    ...
    Qb = function (a) {
        a.i && (null == a.j ? Pb(a) : void 0 !== a.j.playbackState ? a.j.playbackState !== a.j.PLAYING_STATE && a.j.playbackState !== a.j.FINISHED_STATE &&
            Pb(a) : Pb(a))
    };
    ...
    // var p=function(a,b,c){this.Fb=a;this.Ka=b;this.$=c;this.j={};this.T=this.i=this.H=null;this.Oa=0},Rb=function(a,b,c){a.i=b;a.T=c},Sb=document.createElement("audio"),Tb="function"==ma(Sb.canPlayType)&&""!=Sb.canPlayType("audio/mpeg")?".mp3":".ogg",Ub=function(a){if(a.i){var b=1E3*a.i.currentTime,c;for(c in a.j){var d=a.j[c];!d.Yb&&d.Eb+a.$<b&&delete a.j[c]}}};
    // var p=function(a,b,c){this.Fb=a;this.Ka=b;this.$=c;this.j={};this.T=this.i=this.H=null;this.Oa=0},Rb=function(a,b,c){a.i=b;a.T=c},Sb=document.createElement("audio"),Tb="function"==ma(Sb.canPlayType)&&""!=Sb.canPlayType("audio/mpeg")?".mp3":".ogg",Ub=function(a){if(a.i){var b=1E3*a.i.currentTime,c;for(c in a.j){var d=a.j[c];!d.Yb&&d.Eb+a.$<b&&delete a.j[c]}}};
    p.prototype.play = function (a, b, c, d, e) {
        ...
        this.H ? (d.connect(this.H), this.H.connect(this.T)) : d.connect(this.T);
        d.loop = !!b;
        try {
            d.buffer = this.Fb.$
        } catch (q) {
        ...
        b ? (d.loopStart = f + (e ? c / 1E3 : 0), d.loopEnd = f + l, d.start(a, f + c / 1E3)) : d.start(a,
            f + c / 1E3, l);
        e = this.Oa++;
        this.j[e] = {
            node: d,
    ...
    kc = function (a) {
        ...
        a.j ? document.addEventListener(a.j, a.i, !1) : b && b.registerPageVisibilityListener && (google.doodle || (google.doodle = {}), google.doodle.pvc = function () {
            a.i && a.i()
    ...
    mc = function (a) {
        var b = a.$ || a.Ka;
        a.Oa && !b ? (a.Oa = !1, a.$b(), ic(a)) : !a.Oa && b && (a.Oa = !0, a.wb())
    },
    ic = function (a) {
    ...
    Qd.prototype.draw = function () {
        ...
        a = this.kb[1] + 10 - a;
        b = this.kb[0] + 40 - b;
        "pcm-bpcm" == this.v && 4 == this.dir ? (x.save(), x.translate(a + c / 2, b), x.scale(-1, 1), U(e, f, c, d, -c / 2, 0), x.restore()) : "pcm-swipe" == this.v ? (e = x.createLinearGradient(a, 0, a + c, 0), e.addColorStop(0, "rgba(104, 186, 253, 1)"),
            e.addColorStop(1, "rgba(104, 186, 253, 0)"), x.fillStyle = e, x.fillRect(a, b, c, d)) : U(e, f, c, d, a, b)
    };
    var W = function (a, b) {
        var c = a.mode;
        a.mode = b;
    ...
    Zd = function (a) {
        if (-1 == a.T || a.Ya)
            a: {
                ...
                if (a.T == Nd[a.H].length) {
                    ...
                    if (64 == a.mode) {
                        a.id == y || a.Ta ? W(a, 128) : (a.mb = !0, W(a, 16));
                        break a
                    }
                    a.T = 0
                }
        ...
        if ((b = Nd[a.H][a.T]) && a.$a[vc]) {
            ...
            case 1:
            case 4:
                a.o[c.axis] < 8 * b.U && (a.o[c.axis] = 8 * b.U, a.Ya = !0);
                break;
            case 2:
            case 8:
                a.o[c.axis] > 8 * b.U && (a.o[c.axis] = 8 * b.U, a.Ya = !0)
    ...
    Td = function (a) {
        ...
        case 0:
            var b =
                a.id != y || 2 != a.mode && 1 != a.mode ? a.nb : wc;
            break;
        case 1:
            b = a.ka;
            break;
    ...
    de = function (a) {
        if (a.dir && a.$a[vc]) {
            ...
            if (b[0] != a.R[0] || b[1] != a.R[1]) {
                sc = !0;
                a.yb && (a.dir = A[a.dir], a.i = 0, a.yb = !1, Wd(a, !0));
                a.w || B[b[0]][b[1]].path ? a.Oa = [b[0], b[1]] : (a.o[0] = a.Oa[0], a.o[1] = a.Oa[1], b[0] = a.Oa[0], b[1] = a.Oa[1], a.dir = 0);
                1 == B[b[0]][b[1]].type && 8 != a.mode ? $d(a, 2) :
                $d(a, 0);
                if (!a.w && B[b[0]][b[1]].Pa) {
                    c = a.id;
                    C--;
                    ...
                    $d(D[c], 1);
                    ae(c);
                    2 == B[b[0]][b[1]].Pa ? (be(4, !1), ce(50, c)) : ce(10, c);
                    B[b[0]][b[1]].Pa = 0;
                    Rd();
                    jd = 90 * z.va;
                    if (fd)
                        ...
                        D[y + 1].hb++, D[y + 1].hb >= z.wa[1] && (D[y + 1].Ta = !0);
                    else if (16 == D[y + 2].mode || 8 == D[y + 2].mode)
                        D[y + 2].hb++, D[y + 2].hb >= z.wa[2] && (D[y + 2].Ta = !0);
                    else if (16 == D[y + 3].mode || 8 == D[y + 3].mode)
                        D[y + 3].hb++, D[y + 3].hb >=
                        z.wa[3] && (D[y + 3].Ta = !0);
                    if (70 == Fc || 170 == Fc)
                        kd = !0, Sc = H[15] + (H[16] - H[15]) * Ud();
                    0 == C && X(9);
                    V()
                }
                a.R[0] = b[0];
                ...
                c = [8 * Math.floor(c), 8 * Math.floor(d)], a.o[1] == c[1] && a.o[0] == c[0] && (a.o[0] == 8 * Hd[0].y && a.o[1] == 8 * Hd[0].x ? (a.o[0] = 8 * Hd[1].y, a.o[1] = 8 * (Hd[1].x - 1)) : a.o[0] == 8 * Hd[1].y && a.o[1] == 8 * Hd[1].x && (a.o[0] = 8 * Hd[0].y, a.o[1] = 8 * (Hd[0].x + 1)), 8 == a.mode && a.o[0] == Jd[0] && a.o[1] == Jd[1] && W(a, 64), a.w || a.o[0] != Kd[0] || a.o[1] != Kd[1] && a.o[1] != Kd[1] + 8 || (c = a.id, kd && (Y("fruit"), kd = !1, ld = !0, Sc = H[14], ce(z.Fa, c))), a.w &&
                    Wd(a, !1), c = B[a.o[0]][a.o[1]], c.intersection && (a.i && a.i & c.Ja ? (0 != a.dir && (a.Ka = a.dir), a.dir = a.i, a.i = 0, a.w || (a.o[0] += a.Qa[0], a.o[1] += a.Qa[1], a.Qa = [0, 0])) : 0 == (a.dir & c.Ja) && (0 != a.dir && (a.Ka = a.dir), a.dir = 0, a.i = 0, $d(a, 0))));
            if (!a.w && a.i && B[b[0]][b[1]].intersection && a.i & B[b[0]][b[1]].Ja) {
                ...
                a.o[0] >= e[0] && a.o[0] <= f[0] &&
                a.o[1] >= e[1] && a.o[1] <= f[1] && (e = R[a.i], a.Qa[e.axis] += e.Ma)
            }
            Yd(a)
        }
    };
    Qd.prototype.move = function () {
        if (0 == F || this.w && 1 == F && (8 == this.mode || 64 == this.mode)) {
            if (0 != this.Na) {
                a: {
                    var a = this.Na;
                    rc || (google.doodle.pacManSound = !0, ee());
                    if (this.dir == A[a])
                        this.dir = a, this.Qa = [0, 0], 2 != this.lb && $d(this, 0), 0 != this.dir && (this.Ka = this.dir), this.i = 0;
                    else if (this.dir != a)
                        if (0 == this.dir)
                            ...
                            if (b && b.Ja & a) {
                                ...
                                c[b.axis] -= b.Ma;
                                var d = 0;
                                c[0] == this.R[0] && c[1] == this.R[1] ? d = 1 : (c[b.axis] -=
                                        b.Ma, c[0] == this.R[0] && c[1] == this.R[1] && (d = 2));
                                if (d) {
                                    this.dir = a;
                                    this.o[0] = this.R[0];
                                    this.o[1] = this.R[1];
            ...
            this.$ ? (Zd(this), 64 == this.mode && Zd(this)) : (de(this), 8 == this.mode && de(this))
        }
    };
    var fe = function (a) {
        ...
        if (8 == F || 14 == F)
            ...
            if (10 == F || 4 == F || 3 == F) {
                ...
                if (8 == a.mode || 64 == a.mode) {
                    ...
                    b = 1 == K ? 60 < Bc ? 1 : 45 < Bc ? 2 : 3 : 2 == K ? 3 : 3 == K || 4 == K ? 4 : 0, c = 13;
                else {
                    c = a.i;
                ...
                b = 0, c = 8, J < z.Bb - z.V && 0 == Math.floor(J / H[1]) % 2 && (b += 2), b += Math.floor(I / 16) % 2;
            b = [c, b]
        } else {
            c = b = 0;
            var d = a.dir;
    ...
    ge = function () {
        D = [];
        for (var a = 0; a < y + 4; a++)
            D[a] = new Qd(a), a < y ? (D[a].w = !1, D[a].mode = 1) : D[a].w = !0
    },
    ie = function (a) {
        nc(Gc);
        a || (a = window.event);
    ...
    je = function (a, b) {
        ...
        d = [0, 0];
        do
            d[0] += c.offsetTop, d[1] += c.offsetLeft;
    ...
    ne = function (a) {
        ...
        1 == a.touches.length && (Jc = a.touches[0].pageX,
            Kc = a.touches[0].pageY, document.addEventListener("touchmove", le, !0), document.addEventListener("touchend", me, !0));
        a.preventDefault();
        a.stopPropagation()
    },
    le = function (a) {
        nc(Gc);
        1 < a.touches.length ? oe() : (Hc = a.touches[0].pageX - Jc, Ic = a.touches[0].pageY - Kc);
        a.preventDefault();
        a.stopPropagation()
    },
    me = function (a) {
    ...
    qe = function (a) {
        ...
        z.Zb || (z.V = Math.round(90 * z.V), z.Bb = z.V + H[1] * (2 * z.Ea - 1), z.Zb = !0);
        for (var b = 0; b < D.length; b++)
            D[b].hb = 0;
        tc = fd = !1;
        for (b = Ec = Dc = Fc = C = 0; b < Fd.length; b++) {
            var c = Fd[b];
            c.S ? (c = c.x + c.S - 1, c > Dc && (Dc = c)) : (c = c.y + c.h - 1, c > Ec &&
                (Ec = c))
        }
        B = [];
        for (b = 0; b <= Ec + 1; b++)
            for (B[8 * b] = [], c = -2; c <= Dc + 1; c++)
                B[8 * b][8 * c] = {
                    path: 0,
                    Pa: 0,
                    intersection: 0
        ...
        for (b = 0; b < Fd.length; b++) {
            ...
            if (c.S) {
                for (var e = 8 * c.y, f = 8 * c.x; f <= 8 * (c.x + c.S - 1); f += 8)
                    B[e][f].path = !0, 0 == B[e][f].Pa && (B[e][f].Pa = 1, C++), !d || f != 8 * c.x && f != 8 * (c.x + c.S - 1) ? B[e][f].type = d : B[e][f].type = 0;
                B[e][8 * c.x].intersection = !0;
                B[e][8 * (c.x + c.S - 1)].intersection = !0
            } else {
                f = 8 * c.x;
                for (e = 8 * c.y; e <= 8 * (c.y + c.h - 1); e += 8)
                    B[e][f].path && (B[e][f].intersection = !0), B[e][f].path = !0, 0 == B[e][f].Pa && (B[e][f].Pa =
                            1, C++), !d || e != 8 * c.y && e != 8 * (c.y + c.h - 1) ? B[e][f].type = d : B[e][f].type = 0;
        ...
        for (b = 8; b <= 8 * Ec; b += 8)
            for (c = 8; c <= 8 * Dc; c += 8)
                B[b][c].Ja = 0, B[b - 8][c].path && (B[b][c].Ja += 1), B[b + 8][c].path && (B[b][c].Ja += 2), B[b][c - 8].path && (B[b][c].Ja += 4), B[b][c + 8].path && (B[b][c].Ja += 8);
        for (b = 0; b < Gd.length; b++)
            c =
                Gd[b], B[8 * c.y][8 * c.x].Pa = 2;
        se(a);
        256 == M && (ue("K"), Wc = N = !0, X(14))
    },
    be = function (a, b) {
        if (4 == a && 0 == z.V)
            ...
            for (c = 0; c < D.length; c++)
                if (d = D[c], d.w) {
                    if (64 == a || b || (d.Db = !0), 4 == a && (d.mb = !1), 8 != d.mode && 16 != d.mode && 32 != d.mode && 128 != d.mode && 64 != d.mode || b)
                        b || 4 == d.mode || d.mode == a || (d.yb = !0), W(d, a)
                } else
                    d.nb = hd, d.ka = id, d.tb =
                        hd, Td(d)
        }
    },
    ve = function (a) {
    ...
    Xd = function (a) {
        if (!md[a]) {
            ...
            md[a] = [];
            for (var d = 0; 90 > d; d++)
                b += a, Math.floor(b) > c ? (md[a].push(!0), c = Math.floor(b)) : md[a].push(!1)
        }
        return md[a]
    },
    X = function (a) {
        ...
        case 13:
            ...
            od = [];
            for (var c in nd.Za)
                a = nd.Za[c].id, 0 < a && (a += y - 1), a = new Qd(a), a.o = [8 * nd.Za[c].y, 8 * nd.Za[c].x], a.Qa = [0, 0], a.w = nd.Za[c].w, od.push(a);
            we();
            Z();
            V()
        }
    ...
    xe = function (a) {
        a = window.event || a;
        a.cancelBubble = !0;
        google.doodle.pacManSound ? (rc = !0, Z(), google.doodle.pacManSound = !1) : (rc = !1, google.doodle.pacManSound = !0, V());
        var b = !rc;
    ...
    pe = function () {
        Mc = !1;
        N = !0;
        0 == Nc ? Lc ? qe(!0) : (Nc = 0, X(13)) : qe(!1)
    },
    we = function () {
        K++;
        if (nd.sequence.length ==
            K)
            pe();
        else {
            var a = nd.sequence[K];
    ...
    Be = function () {
        ...
        var b = 0;
        P > Pd ? (b = Math.floor(P / Pd), P -= Pd * b) : P < -Pd && (b = Math.ceil(P / Pd), P -= Pd * b);
        b = 1 + b;
        pd = a;
        if (13 == F) {
            for (a = 0; a < b; a++) {
            ...
            for (a = 0; a < b; a++) {
                    ...
                    a: for (sc = !1, d = y; d < y + 4; d++)
                        for (c = 0; c < y; c++)
                            if (D[d].R[0] == D[c].R[0] && D[d].R[1] == D[c].R[1]) {
                                ...
                                8 != D[d].mode && 16 != D[d].mode && 32 != D[d].mode && 128 != D[d].mode && 64 != D[d].mode && (yc = c, X(2))
                            }
                    for (c = y; c < y + 4; c++)
                        if (d = D[c], d.id == y && C < z.ya && 2 == d.mode && (!tc || 16 !=
                                D[y + 3].mode))
                            e = D[d.wb], d.j = [e.R[0], e.R[1]];
                        else if (d.w && 1 == d.mode)
                            switch (e = D[d.wb], d.id) {
                            case y:
                                d.j = [e.R[0], e.R[1]];
                                break;
                            case y + 1:
                ...
                if (0 == F) {
                    ...
                    if (J)
                        J--, 0 >= J && (J = 0, be(uc, !1));
                    else if (0 < Uc && (Uc--, 0 >= Uc && (Uc = 0, Tc++, z.ma[Tc])))
                        switch (Uc = 90 * z.ma[Tc], E) {
                        case 2:
                            be(1, !1);
                            break;
                        case 1:
        ...
        if (N) {
            if (Xc) {
                ...
                if (ad)
                    for (d = 8; d <= 8 * Ec; d += 8)
                        for (e = 8; e <= 8 * Dc; e += 8)
                            2 == B[d][e].Pa && (a = e + -32 + 10, c = d + 0 + 40, U(2, 182, 8, 8, a, c));
                Yc && (b.fillStyle = "#ffaaa5", b.fillRect(289, 86, 19, 2));
                if (kd || ld)
                    a = ld ? [128, 16 *
                            (z.ha - 1)] : ve(z.ha), d = a[0] / 8 * 10 + 2, e = a[1] / 8 * 10 + 2, a = Kd[1] + -32 + 10 - 8, c = Kd[0] + 0 + 40 - 4, U(d, e, 32, 16, a, c);
                if (1 == F) {
            ...
            bd && (U(202, 72, 48, 8, -2, 8), 2 == y && U(202, 82, 48, 8, 62, 8));
            De(0);
            2 == y && De(1);
            if (Wc) {
                b.save();
                ...
                for (a = 280; 472 >= a; a += 8)
                    for (c = 0; 136 >= c; c += 8)
                        .03 > Ud() && (dd = 10 * Math.floor(25 * Ud()),
                            ed = 10 * Math.floor(2 * Ud())), U(dd, ed, 8, 8, a + 10, c + 40), ed += 8;
                b.restore()
            }
            Ce();
            for (a = 0; a < Qc; a++)
    ...
    Ce = function () {
        for (var a = Math.max(M - 4 + 1, 1), b = M; b >= a; b--) {
            var c = ve(b >= Md.length ? Md[Md.length -
                        1].ha : Md[b].ha);
    ...
    ce = function (a, b) {
        Oc[b] += a;
        !Pc[b] && 1E4 < Oc[b] && (Y("extra-life"), Pc[b] = !0, Qc++, 5 < Qc && (Qc = 5))
    },
    Y = function (a) {
    ...
    ae = function (a) {
        ud && google.doodle.pacManSound && 0 == F && (sd[a] ? td[a] = !0 : (0 == a ? (Y(1 == Vc[a] ? "eating-dot-1" : "eating-dot-2"), wd = window.setInterval(Ee, 150)) : (Y("eating-dot-double"),
                        xd = window.setInterval(Fe, 150)), Vc[a] = 3 - Vc[a]))
    },
    Ge = function (a) {
        sd[a] = !1;
        td[a] && (td[a] = !1, ae(a))
    ...
    V = function () {
        if (ud && google.doodle.pacManSound) {
            ...
            if (a) {
                ...
                b || (vd = a, Q.get(a).play(0, !0))
            }
        }
    },
    He = function () {
        Ae = !1;
        ze ? V() : (V(), pd = (new Date).getTime(), P = 0, Be())
    },
    Ie = function () {
        Ae =
            !0;
    ...
    Ke = function () {
        ...
        if (Ad && Bd && (Je(1), !zd)) {
            ...
            L.tabIndex = 0;
            L.focus();
            ud && (O = document.createElement("div"), O.style.background = "url(/logos/pacman10-hp-sprite-3.png) 38px 18px no-repeat", O.style.position =
                    "absolute", O.style.right = "0", O.style.top = "0", O.style.width = "12px", O.style.height = "12px", O.style.border = "10px solid black", O.style.cursor = "pointer", yd.appendChild(O), O.onclick = xe, ee());
            md = [];
            A = [, 2, 1, , 8, , , , 4];
            window.addEventListener ? (window.addEventListener("keydown", ie, !1), L.addEventListener("click", ke, !1), document.addEventListener("touchstart", ne, !0), L.addEventListener("touchstart", ne, !0), document.f && document.f.q && document.f.q.addEventListener("touchstart", ne, !0)) : (document.body.attachEvent("onkeydown",
                    ie), L.attachEvent("onclick", ke));
            H = {};
            for (var b in Ld)
    ...
    google.pacman.destroy = function () {
        if (google.pacman) {
            ...
            window.removeEventListener && (window.removeEventListener("MozGamepadConnected", ec, !1), window.removeEventListener("MozGamepadDisconnected", fc, !1));
            cc = !1;
            var a = Gc;
    ...
    0 == function () {
        if (window.localStorage) {
            ...
            if (a && (a = a.toLowerCase(), "0" != a && "no" != a && "false" != a))
                return !0;
            if (null != a)
                return !1
        }
    ...
    () && (rc = !0, google.doodle.pacManSound = !1);
    Ad = ud = !1;
    if (function () {
        var a = w.j(),
        b = yd;
    ...
    ac = yd;
    bc = null;
    // window.addEventListener&&(window.addEventListener("MozGamepadConnected",ec,!1),window.addEventListener("MozGamepadDisconnected",fc,!1));!navigator.webkitGamepads&&!navigator.webkitGetGamepads||cc||(cc=!0,dc());}).call(this);
    // window.addEventListener&&(window.addEventListener("MozGamepadConnected",ec,!1),window.addEventListener("MozGamepadDisconnected",fc,!1));!navigator.webkitGamepads&&!navigator.webkitGetGamepads||cc||(cc=!0,dc());}).call(this);
